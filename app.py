...
def predict(model, img_bgr):
    ...
    # Sync class names from model if needed
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    if uploaded_video:
        ...
        while True:
            ...
            label = f"{model.names[pred_idx]}  {pred_conf*100:.1f}%"
            color = CLASS_COLORS_BGR.get(model.names[pred_idx], (200, 200, 200))
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    for col, t in zip(cols, techs):
        ...
        <div style="background:#1a1d2e;border:1px solid #2d3561;border-radius:10px;
                    ...
                    font-size:0.85rem;color:#c8cfe8;">
            {t}
